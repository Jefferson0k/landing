...
<template>
    <div class="fixed top-0 left-0 w-full z-50 py-6 px-6 mx-0 md:px-12 lg:px-20 flex items-center justify-between rounded-b-2xl shadow-lg"
        ...
        <a class="flex items-center" href="#">
            <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl lg:text-white leading-normal mr-20">ZUMA</span>
        </a>
            ...
            <ul class="list-none p-0 m-0 flex lg:items-center select-none flex-col lg:flex-row cursor-pointer gap-8">
                <li>
                    <a @click="smoothScroll('hero')"
                        class="px-0 py-4 text-surface-900 dark:text-surface-0 lg:text-white font-medium text-xl hover:text-gray-200 transition-colors">
                        <span>Nosotros</span>
                    </a>
                </li>
                <li>
